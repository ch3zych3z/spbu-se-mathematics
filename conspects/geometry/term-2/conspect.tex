...
\begin{document}
	...
	\begin{MyList}
		...
		\item Пусть $\{\overline{a}_i\}$ -- ЛЗ. Тогда $\{\overline{a}_i, \overline{b}_j\}_{i = 1, j = 1}^{n, m}$ -- ЛЗ.
	\end{MyList}
...
Возьмем произвольную точку $M$ на эллипсе и опустим из нее перпендикуляр. Как мы недавно выяснили, его длина равна расстоянию до фокуса.
